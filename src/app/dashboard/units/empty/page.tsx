...
import { Building, Map, Plus, RefreshCw, Filter, List, Grid3X3, Home, Store, Car } from 'lucide-react';
...
// Mock data for empty units
const mockUnits = [];
const mockQuickStats = {
  apartmentUnits: { total: 10 },
  villaUnits: { total: 2 },
  commercialUnits: { total: 1 },
  parkingSpaces: { total: 20 }
};
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              <div>
                <h2 className="text-xl font-semibold text-text-on-light dark:text-text-on-dark mb-1">
                  Boş Konutlar <span className="text-primary-gold">({mockUnits.length} Konut)</span>
                </h2>
              ...
              <div className="lg:col-span-1">
                <Card>
                  <div className="p-8 text-center">
                    <EmptyState
                      icon={<Building />}
                      title="Boş Konut Bulunamadı"
                      description="Şu anda boş durumda olan konut kaydı bulunmuyor."
                    />
                  </div>
                </Card>
              </div>
